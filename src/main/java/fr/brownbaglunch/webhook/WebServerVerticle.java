...
public class WebServerVerticle extends AbstractVerticle {
    ...
    private final static Logger logger = LogManager.getLogger(WebServerVerticle.class);
    ...
    WebServerVerticle(int port, String token, String root, String branch, String source) {
        this.port = port;
        this.token = token;
        this.root = root;
        this.branch = branch;
