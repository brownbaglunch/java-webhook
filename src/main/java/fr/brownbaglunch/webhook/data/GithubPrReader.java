...
public class GithubPrReader {
    private final static Logger logger = LogManager.getLogger(GithubPrReader.class);
    ...
    public static GithubPrEvent toGithubEvent(String json) throws IOException {
        return mapper.readValue(json, GithubPrEvent.class);
    }
}
